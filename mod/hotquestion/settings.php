...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('mod_hotquestion/heatlimit',
        get_string('heatlimit', 'hotquestion'),
        get_string('heatlimit_descr', 'hotquestion'),
        5, $tl)
    );
    ...
    // Default view after time close setting.
    $settings->add(new admin_setting_configcheckbox_with_advanced('mod_hotquestion/viewaftertimeclose',
        get_string('viewaftertimeclose', 'hotquestion'),
        get_string('viewaftertimeclose_descr', 'hotquestion'),
        ['value' => 1, 'adv' => false])
    );
