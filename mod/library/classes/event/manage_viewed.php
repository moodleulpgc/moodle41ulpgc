...
class manage_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventlibrarymanaged', 'mod_library');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has displayed the managing page for Library activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/library/manage.php', array('id' => $this->contextinstanceid, 'action'=>$this->other['action']));
    }
