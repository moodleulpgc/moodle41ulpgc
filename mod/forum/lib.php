...
function forum_user_can_see_post($forum, $discussion, $post, $user = null, $cm = null, $checkdeleted = true) {
    ...
    if ($forum->type == 'qanda') {
        ...
        //$forum->blockperiod hack by ecastro ULPGC to allow bypass editingtime in quanda forums
        return (($userfirstpost !== false && (time() - $userfirstpost >= $CFG->maxeditingtime || ($forum->blockperiod == 0 && $forum->blockafter < 0))) ||
