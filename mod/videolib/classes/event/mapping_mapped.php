 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mapping_mapped extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventmappingmapped', 'mod_videolib');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' has mapped videolib keys to instances 
