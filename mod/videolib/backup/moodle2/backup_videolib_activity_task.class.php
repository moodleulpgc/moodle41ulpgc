 ...
 */
class backup_videolib_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_videolib_activity_structure_step('videolib_structure', 'videolib.xml'));
    }
