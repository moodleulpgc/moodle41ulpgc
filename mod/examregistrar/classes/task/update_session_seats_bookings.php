 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class update_session_seats_bookings extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('updatesessionseatsbookingstask', 'mod_examregistrar');
    }
    ...
    public function execute() {
        ...
        examregistrar_update_session_seats_bookings($trace);
        $trace->finished();
    }
}
