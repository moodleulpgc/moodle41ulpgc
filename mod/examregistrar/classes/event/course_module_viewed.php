...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the page '{$this->other['tab']}'   for '{$this->objecttable}' activity with " .
    ...
    public function get_url() {
        return new \moodle_url("/mod/$this->objecttable/view.php", array('id' => $this->contextinstanceid, 'tab'=>$this->other['tab']));
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['tab'])) {
            throw new \coding_exception('Examregistrar view needs a tab var');
        }
    }
}
