 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class examfile_updated extends examfile_created {
    /**
    ...
    public function get_description() {
        return "Attempt '{$this->other['attempt']}' for exam '{$this->other['examid']}', {$this->other['idnumber']}, has been updated as '{$this->other['status']}' ".
    ...
    public static function get_name() {
        return get_string('eventexamfileupdated', 'mod_examregistrar');
    }
}
