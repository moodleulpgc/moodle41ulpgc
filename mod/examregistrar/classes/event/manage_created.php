 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class manage_created extends \core\event\base {
     ...
     *
     * @param array $data
     * @param string $table manage table concerned
     * @return \core\event\base returns instance of new event
     */
    public static function created(array $data = null, $table = '') {
        global $USER, $CFG;    
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has added item '{$this->objectid}' in table '{$this->objecttable}' $named" .
    ...
    public static function get_name() {
        return get_string('eventmanage', 'examregistrar', 'created');
    }
