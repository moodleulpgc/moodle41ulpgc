 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class responses_distributed extends responses_approved {
    ...
    public function get_description() {
        $user = $this->usertext();
        $site = $this->get_site(); 
        return "The $user has distributed response files '{$this->other['files']}' for session '{$this->other['session']}' exam '{$this->other['examid']}' 
                $site 
