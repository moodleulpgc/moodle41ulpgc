...
class examfile_synced extends examfile_created {
    ...
    public function get_description() {
        return "Examfile '{$this->objectid}' with attempt '{$this->other['attempt']}' for exam '{$this->other['examid']}', '{$this->other['idnumber']}', synchronized with tracker issue '{$this->other['examid']}' ".
