...
// ecastro ULPGC set page url make subpage by capabilities not groups
...
*/
$defaultsubpage = has_capability('mod/scheduler:canscheduletootherteachers', $context) ? 'allappointments' : 'myappointments';
// ecastro ULPGC
