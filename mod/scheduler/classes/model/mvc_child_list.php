...
class mvc_child_list {
    ...
    /**
     * @var string sort order in SQL // ecastro ULPGC
     */
    private $childorder = null;
    ...
    public function __construct(mvc_record_model $parent, $childtable, $childfield,
        ...
        // ecastro ULPGC
        if(isset($parent->childrenorder)) {
            $this->childorder = $parent->childrenorder;
        }
        //ecastro ULPGC
    }
    ...
    public function load() {
        ...
        if (!is_null($this->children)) {
            ...
            $this->children = array();
            $childrecs = $DB->get_records($this->childtable, array($this->childfield => $this->get_parent_id()), $this->childorder); // ecastro ULPGC
            $cnt = 0;
