...
class appointment extends mvc_child_record_model {
    ...
    public function __construct(slot $slot) {
        ...
        // ecastro ULPGC needed for having notes on calendar events
        $this->data->studentnoteformat = FORMAT_HTML;
        $this->data->studentnote = '';
        $this->data->groupid = 0;
        // ecastro
    }
    ...
    public function delete() {
        ...
        if ($completion->is_enabled($cm) == COMPLETION_TRACKING_AUTOMATIC &&
           ($forum->completionappoinments || $forum->completionattended)) {
            $completion->update_state($cm, COMPLETION_INCOMPLETE, $studid);
        }
        // ecastro ULPGC
