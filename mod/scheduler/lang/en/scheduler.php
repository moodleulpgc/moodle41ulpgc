...
$string['attendednondeletable'] = 'Some slots ({$a}) have not been deleted because the meeting was attended.';
$string['cancelonly'] = 'Only on cancel'; // ecastro ULPGC
...
$string['notusedslots'] = 'Not appointed slots'; // ecastro ULPGC
$string['pagesize'] = 'Slots per page'; // ecastro ULPGC
...
Conversely, slots created here could be marked as shared, to be available in other Scheduler instances as well.'; // ecastro ULPGC
...
$string['cancelbookingconfirm'] = 'You are about to cancel a booking on {$a} <br /> 
Do yo want to proceed?';
$string['asmemberof'] = 'As member of group {$a}'; // ecastro ULPGC
$string['noreplyname'] = 'Automatic message from Scheduler'; // ecastro ULPGC
$string['completionappointmentsgroup'] = 'Require appoinments';
$string['completionappointments'] = 'Has booked appointments, at least: ';
$string['completionappointmentsdesc'] = 'User has booked appointments';
$string['completionattended'] = 'Has attended appointments, at least: ';
$string['completionattendeddesc'] = 'User has booked appointments and has been marked as attending the meeting';
$string['completionattendedgroup'] = 'Require attended';
$string['multiplestudents'] = '{$a} students'; 
