...
class backup_moodleoverflow_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $moodleoverflow = new backup_nested_element('moodleoverflow', array('id'), array(
            ...
            'ratingpreference', 'coursewidereputation', 'allownegativereputation', 'anonymous', 'needsreview',
            'completiondiscussions', 'completionanswers', 'completioncomments', 'completionsuccess', 
            'repcountvotes', 'repcountposts', 'repcountownvotes', 'votefactorpost', 'votefactorcomment', 'votefactorvote', 
            'lockdiscussions', 'lockuntildate'
        ...
        $post = new backup_nested_element('post', array('id'), array(
            ...
            'mailed', 'message', 'messageformat', 'attachment', 'reviewed', 'timereviewed')); // ecastro ULPGC
