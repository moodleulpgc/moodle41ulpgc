...
$string['resetanonymous_warning'] = 'Are you sure? If you are in production, 
<b>this is most certainly a bad decision</b> because your students and teachers posted their questions and answers, 
believing they would remain anonymous. 
<br><br><b>{$a->fullanoncount}</b> forums are currently fully anonymized, 
and in <b>{$a->questionanoncount}</b> additional forums the questioners are anonymized.
<br><br><b>In all these forums, the real names of posters will be displayed again, even in already existing posts!</b>
<br><br>There is no way of reverting those changes!</br>';
...
$string['repcountposts'] = 'Count posts and comments.';
$string['repcountposts_help'] = 'If marked, posts and comments written by a student 
will be included in grades calculated from reputation for that student.';
$string['repcountownvotes'] = 'Count emitted votes.';
$string['repcountownvotes_help'] = 'If marked, then the voting participation (votes emitted by an student for others), 
will be included in grades calculated from reputation for that student.';

$string['votescalepost']               = 'Reputation: Post.';
$string['configvotescalepost']         = 'The amount of reputation a post gives.';
...
it may be locked to redirect students to work in other topics.  
This option allows to define when a lokcing will be enabled:  

 * Never: no locking; students can post in all discussions.
 * Solved: No posting when the discussion is marked as solved. 
 * Helpful/best: No posting when the discussion has posts marked as helpful or best.   
 * Both: Only limit new posting when the discussion has both post marked as solved and marked as helpful/best.
';
$string['locknever'] = 'Never';
$string['locksolved'] = 'Marked Solved';
$string['lockhelpful'] = 'Marked Helpful';
$string['lockboth'] = 'Marked both Solved & Helpful';
$string['lockuntildate'] = 'Lock until date';
$string['lockuntildate_help'] = 'If set then locking will be enforced only before this date. 
After the set date there will be no limitation for posting in any discussion. Lockings will be ineffective. ';
$string['stdreputation'] = 'Reputation votes';
$string['stdreputationcalc'] = 'These are the standard reputation points gained by an student when: <br />
 * Other students vote on a post by this student: Up, + {$a->votescaleupvote}, Down: {$a->votescaledownvote}. <br />
 * An owned post is marked solved: {$a->votescalesolved}.<br />
 * An owned post is marked best/helpful: {$a->votescalehelpful}.<br />
 * The student vote for other posts: {$a->votescalevote} (= 100% for other calculations).<br />
';
$string['votefactorpost'] = 'Reputation factor for posting';
$string['votefactorpost_help'] = 'When an student added a response will gain factor/100 reputation points.';
$string['votefactorcomment'] = 'Reputation factor for comments';
$string['votefactorcomment_help'] = 'When an student added a comment to other responses, will gain factor/100 reputation points.';
$string['votefactorvote'] = 'Reputation factor for voting';
$string['votefactorvote_help'] = 'When an student vote on other posts will receive factor/100 reputation points.';
$string['votefactorerror'] = 'The reputation factor must be a positive integer different than 0';
$string['postreputation'] = 'Reputation by posting';
$string['postreputationcalc'] = 'These are the reputation points gained by an student in this activity 
when the configured factors are applied: <br />
 * The student writes a response post: {$a->votescalepost}.<br />
 * The student writes a comment post: {$a->votescalecomment}.<br />
 * The student vote for other posts by other students: {$a->votescalevote}.<br />
';
