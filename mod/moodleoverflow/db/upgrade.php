...
function xmldb_moodleoverflow_upgrade($oldversion) {
    ...
    if ($oldversion < 2021111600) {    
        ...
        // Define field repcountvotes to be added to moodleoverflow.
        $field = new xmldb_field('repcountvotes', XMLDB_TYPE_INTEGER, '1', null, XMLDB_NOTNULL, null, 0, 'anonymous');
        ...
        // Define field repcountposts to be added to moodleoverflow.
        $field = new xmldb_field('repcountposts', XMLDB_TYPE_INTEGER, '1', null, XMLDB_NOTNULL, null, 1, 'repcountvotes');
        ...
        // Define field repcountownvotes to be added to moodleoverflow.
        $field = new xmldb_field('repcountownvotes', XMLDB_TYPE_INTEGER, '1', null, XMLDB_NOTNULL, null, 0, 'repcountposts');
        ...
        // Define field votefactorpost to be added to moodleoverflow.
        $field = new xmldb_field('votefactorpost', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, 100, 'repcountownvotes');
        ...
        // Define field votefactorcomment to be added to moodleoverflow.
        $field = new xmldb_field('votefactorcomment', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, 100, 'votefactorpost');
        ...
        // Define field votefactorvote to be added to moodleoverflow.
        $field = new xmldb_field('votefactorvote', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, 25, 'votefactorcomment');
        ...
        // Define field lockdiscussions to be added to moodleoverflow.
        $field = new xmldb_field('lockdiscussions', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, 0, 'votefactorvote');
        ...
        // Define field lockuntildate to be added to moodleoverflow.
        $field = new xmldb_field('lockuntildate', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, 0, 'lockdiscussions');
        ...
        // Moodleoverflow savepoint reached.
        upgrade_mod_savepoint(true, 2021111600, 'moodleoverflow');
