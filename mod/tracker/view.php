...
/// important! to print after tabs ecastro ULPGC
    ...
    if ($result != -1) {
        switch ($screen) {
            ...
            case 'browse':
                ...
                break;
            case 'user': // ecastro ULPGC
                //$resolved = 0;
                include "views/viewuserlist.php";
                break;
            case 'search':
            ...
            case 'editanissue' :
                ...
                break;
            case 'assigns':
                include "views/manageassigns.php"; // ecastro ULPGC
                break;
    ...
    if ($result != -1) {
        switch ($screen) {
            ...
            case 'manageelements':
                ...
                break;
            case 'managefiles':
                include "views/admin_managefiles.php"; // ecastro ULPGC
                break;
            case 'managewords':
                include "views/admin_managewords.php"; // ecastro ULPGC
                break;
            case 'managenetwork':
