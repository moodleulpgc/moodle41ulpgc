...
if ($sheetloaded) {
    ...
    foreach ($userkeyhotspots as $key => $hotspot) {
        // ecastro ULPGC
        if($key == 'moodleid') {
            echo "<img src=\"$CFG->wwwroot/mod/offlinequiz/pix/green.gif\" border=\"0\" id=\"moodleid\" title=\"moodleid\" style=\"position:absolute; top:".$hotspot->y."px; left:".
            $hotspot->x."px; cursor:pointer; z-index: 100;\" >";
            continue;
        }
        if($key == 'idnumber') {
            echo "<img src=\"$CFG->wwwroot/mod/offlinequiz/pix/green.gif\" border=\"0\" id=\"idnumber\" title=\"idnumber\" style=\"position:absolute; top:".$hotspot->y."px; left:".
            $hotspot->x."px; cursor:pointer; z-index: 100;\" >";
            continue;
        }
        if($key == 'cross') {
            echo "<img src=\"$CFG->wwwroot/mod/offlinequiz/pix/green.gif\" border=\"0\" id=\"cross\" title=\"cross\" style=\"position:absolute; top:".$hotspot->y."px; left:".
            $hotspot->x."px; cursor:pointer; z-index: 100;\" >";
            continue;
        }
        
        if($key == 'deleted') {
            echo "<img src=\"$CFG->wwwroot/mod/offlinequiz/pix/green.gif\" border=\"0\" id=\"deleted\" title=\"deleted\" style=\"position:absolute; top:".$hotspot->y."px; left:".
            $hotspot->x."px; cursor:pointer; z-index: 100;\" >";
            continue;
        }
