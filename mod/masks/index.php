...
/**
 * List of instances of masks module in the course
 *
...
$event = \mod_masks\event\course_module_instance_list_viewed::create($params);
$event->add_record_snapshot('course', $course);
$event->trigger();

$strinstance     = get_string('modulename', 'masks');
$strinstances    = get_string('modulenameplural', 'masks');
$strname         = get_string('name');

$PAGE->set_url('/mod/masks/index.php', array('id' => $course->id));
...
if (!$instances = get_all_instances_in_course('masks', $course)) {
