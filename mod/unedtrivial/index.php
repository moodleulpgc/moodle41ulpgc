...
/**
 * Library of functions and constants for module UNEDTrivial
 *
...
$PAGE->set_url('/mod/unedtrivial/index.php', array('id' => $id));
...
if (! $newmodules = get_all_instances_in_course('unedtrivial', $course)) {
    notice(get_string('nonewmodules', 'unedtrivial'), new moodle_url('/course/view.php', array('id' => $course->id)));
}
...
$currentsection = '';
foreach ($modinfo->instances['unedtrivial'] as $cm) {
    $row = array();
    if ($usesections) {
