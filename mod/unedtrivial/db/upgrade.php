 ...
 * @return bool
 */
function xmldb_unedtrivial_upgrade($oldversion) {
    global $DB;
...
/*	 
    if ($oldversion < 2007040100) {
        ...
        $table = new xmldb_table('unedtrivial');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'unedtrivial');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        upgrade_mod_savepoint(true, 2007040101, 'unedtrivial');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'unedtrivial');
    }
*/
    /*
