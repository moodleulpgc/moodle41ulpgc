...
/**
 * Student form for question type 2 (MULTIPLE)
 *
...
class goquestion2form extends moodleform {
	public $e = '';
        public $o1;
        public $o2;
        public $o3;
    ...
    public function definition() {
        ...
        $mform->addElement('checkbox', 'istrue1', '');
        $mform->addElement('checkbox', 'istrue2', '');
        $mform->addElement('checkbox', 'istrue3', '');
        $mform->addElement('checkbox', 'istrue4', '');
