...
class renderer extends \plugin_renderer_base {
    ...
    public function render_assign_grading_summary(\assign_grading_summary $summary) {
        ...
        // ecastro ULPGC preserve link to grading page
    ...
    public function render_assign_submission_status(assign_submission_status $status) {
        ...
        if ($submission) {
            ...
            if(isset($status->modifiedafterwarning) && $status->modifiedafterwarning) { // ecastro ULPGC, to add group sumbbision modified after warning
                $t->data[] = $status->modifiedafterwarning;
            }            
