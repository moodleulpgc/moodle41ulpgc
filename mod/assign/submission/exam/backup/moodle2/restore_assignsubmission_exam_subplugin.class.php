...
/**
 * This exam contains the class for restore of this submission plugin
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignsubmission_exam_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_exam');
    ...
    /**
     * Processes one submission_exam element
     * @param mixed $data
     * @return void
     */
    public function process_assignsubmission_exam_submission($data) {
        global $DB;
