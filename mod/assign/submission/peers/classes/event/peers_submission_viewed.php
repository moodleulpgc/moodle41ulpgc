 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class peers_submission_viewed extends \mod_assign\event\submission_viewed {
    ...
    public function get_description() {
        return "User {$this->userid} has viewed the submission of peer user {$this->relateduserid} ".
    ...
    public static function get_name() {
        return get_string('eventpeerssubmissionviewed', 'assignsubmission_peers');
    }
