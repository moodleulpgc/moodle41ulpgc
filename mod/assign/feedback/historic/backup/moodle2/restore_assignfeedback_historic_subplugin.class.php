 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignfeedback_historic_subplugin extends restore_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/feedback_historic');
    ...
    /**
     * Processes one feedback_historic element.
     * @param mixed $data
     */
    public function process_assignfeedback_historic_grade($data) {
        global $DB;
        ...
        $DB->insert_record('assignfeedback_historic', $data);
    }
}
