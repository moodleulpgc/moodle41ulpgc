    ...
    public function definition() {
        ...
        if ($instance['submissionsenabled']) {
            if($ulpgc) {
                ...
                $mform->addElement('static', 'filtermsg', '', '' ); // ecastro ULPGC filterring out users message warning
            }
        ...
        // new grading panel. // ecastro ULPGC
        if ($ulpgc && isset($instance['hidegradingpanel'])) {
            $mform->addElement('advcheckbox', 'hidegradingpanel', get_string('hidegradingpanel', 'local_ulpgcassign'), '', $dirtyclass);
            $mform->addHelpButton('hidegradingpanel', 'hidegradingpanel', 'local_ulpgcassign');
            $mform->setDefault('hidegradingpanel', $instance['hidegradingpanel']);
        }
