...
class updatesession extends \moodleform {
    ...
    public function definition() {
        ...
        $data = array(
            ...
            // ecastro uLPGC
            'seatrows' => $sess->seatrows,
            'seatcols' => $sess->seatcols,
            'seatblocking' => $sess->seatblocking
        );
        ...
        // ecastro ULPGC
        if (!empty(get_config('attendance', 'seatingactivitylevel')) &&  $DB->get_field('attendance', 'seating', array('id' => $sess->attendanceid))) {
