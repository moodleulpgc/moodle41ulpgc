...
class mod_attendance_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        // ecastro ULPGC
        if(get_config('attendance', 'seatingactivitylevel')) {
            $mform->addElement('advcheckbox', 'seating', get_string('useseating', 'attendance'). ' ');
            $mform->addHelpButton('seating', 'useseating', 'attendance');
        }
        // ecastro ULPGC
