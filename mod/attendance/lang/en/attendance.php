...
$string['place'] = 'Place';
$string['seatingactivitylevel'] = 'Allow seating config at activity level';
$string['seatingactivitylevel_desc'] = 'If enabled, teachers can config an instance to record attendance with seating information for each user .';
$string['seatblocking'] = 'Blocked seats';
$string['seatblocking_help'] = 'A comma-separated list of seats, non-bookable or blocked seats. 
The studenst cannot book or be placed in these seats.';
$string['seatbookingadvance'] = 'Seat booking in advance';
$string['seatbookingadvance_desc'] = 'Number of days in advance to book session seats. 
An student will be able to book seats in sessions up to this days in future. ';
$string['seatcol'] = 'Column';
$string['seatrow'] = 'Row {$a}';
$string['seated'] = 'Taken';
$string['seatrows'] = 'Num rows';
$string['seatrows_help'] = 'The number of seating rows in the classroom. First row is the closer to the presenter / teacher / blackboard / screen';
$string['seatcols'] = 'Num columns';
$string['seatcols_help'] = 'The number of seating columns in the classroom. First column counting from right hand from teacher point of view, most to left viewing as student.';
$string['submitplace'] = 'Book seat';
$string['updateplace'] = 'Update seat';
$string['useseating'] = 'Record seat info';
$string['useseating_help'] = 'If enabled, a seat map will be presented to students to allow to record the place in th eclassroom where thwy arw seated.';
$string['seatlabel'] = 'R{$a->row} C{$a->col}';
$string['seattaken'] = 'Seat already taken, please select another one';
$string['seatblackboard'] = 'Blackboard / Screen';
