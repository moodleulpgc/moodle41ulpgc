...
if ($ADMIN->fulltree) {
    ...
    // ecastro ULPGC    
    $settings->add(new admin_setting_configcheckbox('attendance/seatingactivitylevel',
        get_string('seatingactivitylevel', 'attendance'),
        get_string('seatingactivitylevel_desc', 'attendance'), 0));
        
    $settings->add(new admin_setting_configtext('attendance/seatbookingadvance',
        get_string('seatbookingadvance', 'attendance'),
        get_string('seatbookingadvance_desc', 'attendance'), 7, PARAM_INT));
    // ecastro ULPGC
    ...
    // ecastro ULPGC    
    $settings->add(new admin_setting_configtext('attendance/seatrows',
        get_string('seatrows', 'attendance'), get_string('seatrows_help', 'attendance'), 5, PARAM_INT));

    $settings->add(new admin_setting_configtext('attendance/seatcols',
        get_string('seatcols', 'attendance'), get_string('seatcols_help', 'attendance'), 7, PARAM_INT));
    // ecastro ULPGC    
