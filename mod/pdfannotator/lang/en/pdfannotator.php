...
// ecastro ULPGC
$string['allowupdate'] = 'Allow file update';
$string['allowupdate_help'] = 'When checked, the existing PDF document may be updated by selecting a new file below. 

All annotations and comments will be obsolete and probably not applicable to the new PDF document.';
$string['removeannotations'] = 'Delete annotations and comments';
$string['removeannotations_help'] = 'When checked, all existing annotations and comments will be removed upon document update.';
