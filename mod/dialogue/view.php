...
$withuser   = optional_param('wu', 0, PARAM_INT); // ecastro ULPGC
...
$pageurl->param('wu', $withuser); // ecastro ULPGC
...
echo $renderer->list_messageswith($dialogue, $pageurl); // ecastro ULPGC
