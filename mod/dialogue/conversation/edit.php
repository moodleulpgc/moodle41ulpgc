...
$conversation = new \mod_dialogue\conversation($dialogue, (int)$conversationrecord->id); // Existing conversation.

$conversation->state = \mod_dialogue\dialogue::STATE_DRAFT;
