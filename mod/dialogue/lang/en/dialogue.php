...
// ecastro ULPGC
$string['multipleconversations'] = 'Multiple conversations'; 
$string['multipleconversations_help'] = 'This parameter controls if a user can maintain several open conversations with the same partner.

If set to NO, then a user can open one and just a single conversation with each other users. Closed conversations does\'t count for this limit.
Teachers are not restricted by this setting. '; 

$string['nomatchingpeoplemultiple'] = 'No people without open conversations: use one of the open conversations.';
$string['dialoguecronnotifications'] = 'Delayed notifications mailing'; 
$string['replyby'] = 'Reply status: {$a}';
$string['any'] = 'Any';
$string['replied'] = 'Replied';
$string['unreplied'] = 'Unreplied';
$string['viewanyby'] = 'Participation: {$a}';
$string['own'] = 'Yes';
$string['other'] = 'No';
$string['dialogue:openasstaff'] = 'Open a conversation as teacher';
$string['dialogue:receiveasstaff'] = 'Receive a conversation as teacher';
$string['alternatemode'] = 'Alternate mode';
$string['alternatemode_help'] = 'When in Alternate mode, the students opening a Dialogue can choose only among course teachers and viceversa. <br />
The potential partners when opening a dialogue dependes on special permissions. If opening user has the capability "Open as teacher", then "receive" users are the potential partners.
In other case (i.e. students opening a Dialogue) the potential partners are those with "Receive as teacher" capability. ';
$string['notifications'] = 'CCopy by e-mail';
$string['notifications_help'] = 'If active, then a copy of each mesage will be sent by e-mail to the recipient user.';
$string['sendkeep'] = 'Send & edit';
$string['configtrackunreplied'] = 'Use unReplied rather than unread tracking on course page';
$string['editmessage'] = 'Edit message';
$string['unrepliedmessagesnumber'] = '{$a} unreplied messages';
$string['unrepliedmessagesone'] = '1 unreplied message';
$string['configeditingtime'] = 'Allow a grace period to edit own message, like in forums.';

$string['completionconversations'] = 'Student must start conversations:';
$string['completionconversationsgroup'] = 'Require conversations';
$string['completionconversationshelp'] = 'requiring conversations to complete';
$string['completionposts'] = 'Student must post messages:';
$string['completionpostsgroup'] = 'Require messages';
$string['completionpostshelp'] = 'requiring messages to complete';
$string['completionreplies'] = 'Student must post replies to others:';
