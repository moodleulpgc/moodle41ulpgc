 ...
 */
class dialogue_notifications_task extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('dialoguecronnotifications', 'dialogue');
    }
    ...
    public function execute() {
        ...
        dialogue_process_waiting_notifications();
    }
