...
class dialogue {
    ...
    /** States to indicate reply status in a conversation **/ // ecastro ULPGC
    const STATE_ANY        = 'any';
    const STATE_REPLIED    = 'replied';
    const STATE_UNREPLIED  = 'unreplied';

    /** The state to indicate only conversations with own participation **/ // ecastro ULPGC
    const STATE_OWN  = 'own';
    ...
    /**
     * Return message states for repied/unreplied
     * FLAG_READ
     *
     * @return array
     */
    public static function get_reply_states() { // ecastro ULPGC
        return array(dialogue::STATE_ANY, dialogue::STATE_UNREPLIED, dialogue::STATE_REPLIED);
    }

    /**
     * Return message states for viewing by admin with viewany capability
     * FLAG_READ
     *
     * @return array
     */
    public static function get_ownership_states() { // ecastro ULPGC
        return array(dialogue::STATE_ANY, dialogue::STATE_OWN, dialogue::STATE_OTHER);
    }
