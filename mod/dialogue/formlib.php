...
class mod_dialogue_message_form extends moodleform {
    ...
    protected function definition() {
        ...
        $actionbuttongroup[] =& $mform->createElement('submit', 'sendkeep', 
            get_string('sendkeep', 'dialogue'), array('class'=>'send-button')); // ecastro ULPGC
    ...
    public function get_submit_action() {
        $submitactions = array('send', 'save', 'cancel', 'trash', 'sendkeep'); // ecastro ULPGC
...
class mod_dialogue_conversation_form extends mod_dialogue_message_form {
    ...
    protected function definition() {
        ...
        if (has_capability('mod/dialogue:bulkopenrulecreate', $context)) {
            ...
            $allowedgroups = groups_get_activity_allowed_groups($cm); // ecastro ULPGC
            /*
