 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attempt_extended extends base_event {
    ...
    public static function get_name() {
        return get_string('event_attempt_extended', 'quiz_attemptstate');
    }

    public function get_description() {
        return 'The user with id ' . $this->userid . ' has reopen and extended the attempt with id ' . $this->other['attemptid'] .
