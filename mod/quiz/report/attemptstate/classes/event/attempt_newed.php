 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attempt_newed extends base_event {
    ...
    public static function get_name() {
        return get_string('event_attempt_newed', 'quiz_attemptstate');
    }

    public function get_description() {
        return 'The user with id ' . $this->userid . ' has created the a new attempt based on attempt with id ' . $this->other['attemptid'] .
