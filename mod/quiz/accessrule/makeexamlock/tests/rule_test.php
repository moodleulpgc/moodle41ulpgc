...
/**
 * Unit tests for the quizaccess_makeexamlock plugin.
 *
 * @package    quizaccess
...
global $CFG;
require_once($CFG->dirroot . '/mod/quiz/accessrule/makeexamlock/rule.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizaccess_makeexamlock_testcase extends basic_testcase {
    public function test_num_attempts_access_rule() {
        ...
        $rule = new quizaccess_makeexamlock($quizobj, 0);
        $attempt = new stdClass();

        $this->assertEquals($rule->description(),
            get_string('attemptsallowedn', 'quizaccess_makeexamlock', 3));
