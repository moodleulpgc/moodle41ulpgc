...
/**
 * Provides the information to backup the makeexamlock quiz access plugin.
 *
 * If this plugin is requires, a single
 * <quizaccess_makeexamlock><makeexamlock>1</makeexamlock></quizaccess_makeexamlock> tag
 * will be added to the XML in the appropriate place. Otherwise nothing will be
 * added. This matches the DB structure.
 */
class backup_quizaccess_makeexamlock_subplugin extends backup_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $subplugin_table_settings = new backup_nested_element('quizaccess_makeexamlock',
                null, array('makeexamlock'));
        ...
        $subplugin_table_settings->set_source_table('quizaccess_makeexamlock',
