...
// ecastro ULPGC
$string['timeadvance'] = 'Mostrar con antelación';
$string['timeadvance_desc'] = 'Muestra el contador cuando el tiempo restante hasta la apertura nominal del Cuestionario es menor que este ajuste. 
Cero para inhabilitar y mostrar siempre el contador.';
