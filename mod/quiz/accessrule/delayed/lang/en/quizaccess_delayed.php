...
// ecastro ULPGC
$string['timeadvance'] = 'Show when';
$string['timeadvance_desc'] = 'Show counter only when time remaining to nominal quiz Open time is lower than this setting. 
Zero to disable and show always.';
