/**
 * Theme Moove - JS code back to top button
 *
 ...
 */
define("theme_moove/backtotopbutton",["jquery","core/str","core/notification"],(function($,str,Notification){let buttonShown=!1;function initBackToTop(){let stringsPromise=str.get_string("backtotop","theme_moove");$.when(stringsPromise).then((function(string){return $("#page-footer-buttons").after('<button id="back-to-top" class="btn btn-icon bg-secondary icon-no-margin btn-footer-popover"aria-label="'+string+'"><i aria-hidden="true" class="fa fa-chevron-up fa-fw "></i></button>'),$("#page").on("scroll",(function(){$("#page").scrollTop()>220?!1===buttonShown&&$("#back-to-top").fadeIn(300,(function(){buttonShown=!0})):!0===buttonShown&&$("#back-to-top").fadeOut(100,(function(){buttonShown=!1}))})),$("#back-to-top").on("click",(function(event){event.preventDefault(),$("#page").animate({scrollTop:0},500),$("#back-to-top").blur()})),!0})).fail(Notification.exception)}return{init:function(){initBackToTop()}}}));
