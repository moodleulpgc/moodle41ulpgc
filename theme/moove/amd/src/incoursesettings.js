...
define(['jquery'], function($) {
    ...
    function initInCourseSettings() {
        ...
        if (!frontpage) {
            ...
            var courseSettings = $('#moove-incourse-settings');
            var activitySettings = $('#moove-inactivity-settings');
            ...
            courseSettingsDropdownToggle.removeAttr('aria-haspopup').attr('aria-controls', 'moove-incourse-settings');
            ...
            activitySettingsDropdownToggle.removeAttr('aria-haspopup').attr('aria-controls', 'moove-inactivity-settings');
