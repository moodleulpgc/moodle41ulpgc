 ...
 *
 * @module     theme_moove/backtotopbutton copied from theme_boost_union/backtotopbutton
...
define(['jquery', 'core/str', 'core/notification'], function($, str, Notification) {
    ...
    function initBackToTop() {
        ...
        let stringsPromise = str.get_string('backtotop', 'theme_moove');
        ...
        $.when(stringsPromise).then(function(string) {
            // Add a fontawesome icon after the footer as the back to top button. d-print-none
            $('#page-footer-buttons').after('<button id="back-to-top" ' +
                    'class="btn btn-icon bg-secondary icon-no-margin btn-footer-popover"' +
                    'aria-label="' + string + '">' +
