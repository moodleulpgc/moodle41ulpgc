...
/**
 * Strings for component 'theme_adaptable', language 'es', branch 'MOODLE_31_STABLE'
 *
 * @package   theme_moove
 * @copyright 2023 onwards Enrique Castro @ULPGC
...
$string['showhintcoursehiddensettingslink'] = 'Usted puede cambiar la visibilidad en la <a href="{$a->url}">Configuración</a> del curso.';
