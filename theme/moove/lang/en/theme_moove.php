...
$string['sitesettingsheading'] = 'Site icons & options';
$string['coursesettingsheading'] = 'Course page options';
$string['iconhome'] = 'Home icon';
$string['iconhome_desc'] = 'Name of a Fontawesome icon to use.';
$string['iconmyhome'] = 'MyHome icon';
$string['iconmyhome_desc'] = 'Name of a Fontawesome icon to use.';
$string['iconmycourses'] = 'My courses icon';
...
$string['showmenuitemicons_desc'] = 'If enabled, the panel will include iconsins addition to link names.';
$string['coursesettingsicon'] = 'Course settings icon';
$string['coursesettingsicon_desc'] = 'Name of a Fontawesome icon to use.';
$string['activitysettingsicon'] = 'Activity settings icon';
$string['activitysettingsicon_desc'] = 'Name of a Fontawesome icon to use.';
$string['switchtorolepositionsetting'] = 'Switch role position';
$string['switchtorolepositionsetting_desc'] = 'Name of a Fontawesome icon to use.';
...
$string['goparenturl'] = 'Go back to parent site';
