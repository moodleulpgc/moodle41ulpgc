...
Feature: availability_date
  ...
  Scenario: Test condition
    ...
    # Add a Page with a timeelapsed condition that does match (from the past).
    ...
    And I click on "Time elapsed" "button" in the "Add restriction..." "dialogue"
    And I click on ".availability-item .availability-eye img" "css_element"
    And I set the field "duration" to "45"
    And I set the field "reference" to "coursestart"
