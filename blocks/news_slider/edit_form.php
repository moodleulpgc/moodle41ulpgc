...
class block_news_slider_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('text', 'config_sliderheight', get_string('sliderheight', 'block_news_slider'));
        $mform->setDefault('config_sliderheight', block_news_slider::NEWS_SLIDER_DEFAULT_SLIDER_HEIGHT);
        $mform->setType('config_sliderheight', PARAM_INT);
        ...
        // Right to Left option. Selected to allow slider to display news when using an RTL language (e.g. Arabic).
        $mform->addElement('selectyesno', 'config_showrtl', get_string('showrtl', 'block_news_slider'));
        $mform->setDefault('config_showrtl', 0);
    }
}
