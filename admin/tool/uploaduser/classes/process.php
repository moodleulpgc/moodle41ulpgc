...
class process {
    ...
    public function process_line(array $line) {
        ...
        // fito@ULPGC-20130315 // ecastro ULPGC
        // Verificar que existe en ldap. En caso contrario se crea.
        if(get_config('local_ulpgccore', 'enableupdateldap')) {
            //include_once($CFG->dirroot.'/local/ulpgccore/lib.php');
            local_ulpgccore_update_ldap($user, 'Alta masiva desde moodle tool/uploaduser');
        }        
