...
if ($userform->is_cancelled()) {
    ...
    if(get_config('local_ulpgccore', 'enableupdateldap')) { // ecastro ULPGC
        // Verificar que existe en ldap. En caso contrario se crea. // fito@ULPGC-20130315
		local_ulpgccore_update_ldap($usernew, 'Alta desde moodle user/editadvanced');
	}
