...
require_once($CFG->dirroot.'/local/ulpgccore/userfield.php'); // ULPGC ecastro
...
class user_filtering {
    ...
    public function __construct($fieldnames = null, $baseurl = null, $extraparams = null) {
        ...
        if (empty($fieldnames)) {
            ...
            $fieldnames['lastlogin'] = 1; // ecastro ULPGC                            
    ...
    public function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'userfield':   return new user_filter_userfield('userfield', get_string('userfield', 'local_ulpgccore'), $advanced);
