...
// Protected API starts here
    ...
    protected function define_settings() {
        ...
        // Define groupbyidnumber  // ecastro ULPGC
        $defaultvalue = true;                      // Safer default
        $changeable = true;
        if (isset($rootsettings['groupbyidnumber']) && $rootsettings['groupbyidnumber']) { // Only enabled when available
            $defaultvalue = false;
            $changeable = true;
        }
        $groupbyidnumber = new restore_generic_setting('groupbyidnumber', base_setting::IS_BOOLEAN, $defaultvalue);
        $groupbyidnumber->set_ui(new backup_setting_ui_checkbox($groupbyidnumber, get_string('restoregroupbyidnumber', 'tool_backuprestore')));
        $groupbyidnumber->get_ui()->set_changeable($changeable);
        $this->add_setting($groupbyidnumber); // ecastro ULPGC new restore groupings setting        
