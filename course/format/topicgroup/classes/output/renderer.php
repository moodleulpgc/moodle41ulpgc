 ...
 * @author Enrqiue Castro @ULPGC
  * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @copyright 2023, Enrqiue Castro
 */

namespace format_topicgroup\output;

//use format_topics\output\renderer as section_renderer;

use core_courseformat\base as course_format;
use core_courseformat\output\section_renderer;
use format_topicgroup\output\courseformat\content;
use section_info;
...
class renderer extends section_renderer {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        //print_object("ESTAMOS en format_topicgroup section_renderer ");
    }
