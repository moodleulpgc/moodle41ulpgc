...
$capabilities = array('moodle/category:manage', 'moodle/course:create');
if(get_capability_info('local/ulpgccore:categoryreview')) { // ecastro ULPGC allow courses resort in non-editable category
    $capabilities[] = 'local/ulpgccore:categoryreview'; 
}
if (!core_course_category::has_capability_on_any($capabilities)) {
