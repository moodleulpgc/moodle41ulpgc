...
class core_course_renderer extends plugin_renderer_base {
    ...
    public function course_activitychooser($courseid) {
        ...
        if($ulpgc = get_config('local_ulpgccore')) {
            $chooserconfig->enabledadvchooser = $ulpgc->enabledadvchooser;
            ...
            foreach($groups as $type => $val) {
                ...
                //$names[$type] = get_string($type, 'local_ulpgccore');
            }
    ...
    function course_section_add_cm_control($course, $section, $sectionreturn = null, $displayoptions = array()) {
        ...
        if($this->adminmods &&
                    !(($section <> 0) || has_capability('local/ulpgccore:managesection0', $coursecontext))) { // ULPGC ecastro disable managing section 0
            return '';
        }
    ...
    public function course_section_cm_list_item($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = []) {
        ...
        if ($modulehtml = $this->course_section_cm($course, $completioninfo, $mod, $sectionreturn, $displayoptions)) {
            ...
            // ecastro ULPGC, enforce no mods in section 0
            if($mod->sectionnum == 0 && $mod->score <> 0) {
                $modclasses .= ' section0-non-admin ';
            } 
            // ecastro ULPGC, enforce no mods in section 0
