...
abstract class grade_export {
    ...
    public function __construct($course, $groupid, $formdata) {
        ...
        $this->enabledadvancedscales = get_config('local_ulpgccore', 'enabledadvancedgrades') && 
                get_config('local_ulpgccore', 'scaledisplaymode'); // ecastro ULPGC to allow detailed scales
    }
     ...
     * @return string
     */
    public function format_grade($grade, $gradedisplayconst = null, $userid = null) { // ecastro ULPGC DETAILED SCALES
        ...
        if($this->enabledadvancedscales && $userid) { // ecastro ULPGC
            $formattedgrade .= local_ulpgccore_format_gradevalue($grade->finalgrade, $gradeitem, $userid);
        }
