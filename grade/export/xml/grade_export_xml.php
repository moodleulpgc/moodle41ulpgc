            ...
            foreach ($userdata->grades as $itemid => $grade) {
                ...
                if (is_array($this->displaytype)) {
                    ...
                    foreach ($this->displaytype as $gradedisplayconst) {
                        $gradestr = $this->format_grade($grade, $gradedisplayconst, $user->id); // ecastro ULPGC apply detailed scales
                        fwrite($handle,  "\t\t<score>$gradestr</score>\n");
                    }
                } else {
                    // Grade display type submitted directly from the grade export form.
                    $gradestr = $this->format_grade($grade, $this->displaytype, $user->id); // ecastro ULPGC apply detailed scales
                    fwrite($handle,  "\t\t<score>$gradestr</score>\n");
                }
