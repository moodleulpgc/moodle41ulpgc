...
$string['regrademessage1'] = 'Je staat op het punt om wijzigingen op te slaan in een checklist die al is gebruikt voor beoordeling.
Geef aan of bestaande cijfers moeten worden herzien. Als je deze optie instelt, wordt de checklist verborgen voor studenten tot hun items opnieuw zijn beoordeeld.';
