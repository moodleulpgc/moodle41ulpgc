 ...
 * @version    $Id: Stream.php 1475 2020-06-03 10:40:29Z jan.slabon $
 */
    ...
    public function toPdfString(SetaPDF_Core_Document $pdfDocument = null)
    {
        if ($pdfDocument === null) {
            throw new InvalidArgumentException(
                'An stream requires a SetaPDF_Core_Document instance ' .
                'to communicate with it in view to encryption.'
            );
        }
