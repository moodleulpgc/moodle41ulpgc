 ...
 * @version    $Id: Name.php 1562 2020-09-24 15:47:29Z maximilian.kresse $
 */
    ...
    implements SetaPDF_Core_Type_ScalarValue
{
    ...
    static public function escape($value)
    {
        ...
        $value = preg_replace_callback(
            $pattern, ['SetaPDF_Core_Type_Name', '_escapeChar'], $value
        );
    ...
    static public function unescape($value)
    {
        ...
        return preg_replace_callback(
            '/#([a-fA-F\d]{2})/', ['SetaPDF_Core_Type_Name', '_unescapeChar'], $value
        );
    }
