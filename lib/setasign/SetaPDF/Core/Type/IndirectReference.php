 ...
 * @version    $Id: IndirectReference.php 1475 2020-06-03 10:40:29Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Type_IndirectObjectInterface
{
    ...
    public function toPdfString(SetaPDF_Core_Document $pdfDocument = null)
    {
        if ($pdfDocument === null) {
            throw new InvalidArgumentException(
                'An indirect reference requires a SetaPDF_Core_Document instance ' .
                'to resolve its id when converted to a string.'
            );
        }
