 ...
 * @version    $Id: Aes256R5.php 1562 2020-09-24 15:47:29Z maximilian.kresse $
 */
...
class SetaPDF_Core_SecHandler_Standard_Aes256R5 extends SetaPDF_Core_SecHandler_Standard
{
    ...
    static public function factory(
        ...
        $passwordsEncoding = 'utf-8'
    )
    {
        $ownerPassword = self::ensurePasswordEncoding(5, $ownerPassword, $passwordsEncoding);
        $userPassword = self::ensurePasswordEncoding(5, $userPassword, $passwordsEncoding);
