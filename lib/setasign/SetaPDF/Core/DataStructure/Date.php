 ...
 * @version    $Id: Date.php 1518 2020-08-20 13:43:58Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_DataStructure_DataStructureInterface
{
    ...
    static public function stringToDateTime($string)
    {
        ...
        try {
            ...
            try {
                // If it is not a PDF Date string, let's try to parse it directly
    ...
    {
        if ($string instanceof SetaPDF_Core_Type_StringValue) {
            $this->_string = $string;
        } else {
