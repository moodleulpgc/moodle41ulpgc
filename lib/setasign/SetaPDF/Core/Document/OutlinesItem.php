 ...
 * @version    $Id: OutlinesItem.php 1547 2020-09-17 15:04:01Z maximilian.kresse $
 */
...
class SetaPDF_Core_Document_OutlinesItem implements RecursiveIterator, ArrayAccess
{
     ...
     */
    static public function create(SetaPDF_Core_Document $document, $titleOrConfig, $config = [])
    {
