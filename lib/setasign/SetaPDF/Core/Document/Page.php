 ...
 * @version    $Id: Page.php 1589 2020-11-16 10:10:41Z jan.slabon $
 */
...
class SetaPDF_Core_Document_Page implements SetaPDF_Core_Canvas_ContainerInterface
{
     ...
     */
    static public function create(SetaPDF_Core_Document $document, $values = [])
    {
    ...
    public function getBoundary($box = SetaPDF_Core_PageBoundaries::CROP_BOX, $fallback = true, $asRect = true)
    {
        ...
        if ($box !== SetaPDF_Core_PageBoundaries::MEDIA_BOX) {
            $mediaBox = $this->getBoundary(SetaPDF_Core_PageBoundaries::MEDIA_BOX, $fallback, true);
            if ($mediaBox === false) {
                return $boundary;
            }
            ...
            if ($mediaBox->intersect($boundary)) {
                ...
                if ($box === SetaPDF_Core_PageBoundaries::CROP_BOX) {
                    ...
                    $boundary = $this->getBoundary(SetaPDF_Core_PageBoundaries::CROP_BOX, true);
                }
            }
        }
