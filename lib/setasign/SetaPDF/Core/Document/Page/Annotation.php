 ...
 * @version    $Id: Annotation.php 1562 2020-09-24 15:47:29Z maximilian.kresse $
 */
  ...
  /* Annotation Flags (F entry) */
    ...
    public function getAppearance($type = 'N', $subName = null)
    {
        ...
        try {
            ...
            if (!$_ap instanceof SetaPDF_Core_Type_Dictionary || !$ap->offsetExists($subName)) {
                return null;
            }

            $ap = $ap->getValue($subName);
            $ap->ensure();
