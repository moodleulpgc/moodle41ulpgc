 ...
 * @version    $Id: Png.php 1587 2020-11-09 15:30:04Z jan.slabon $
 */
...
class SetaPDF_Core_Image_Png extends SetaPDF_Core_Image
{
    ...
    protected function _process()
    {
        ...
        $this->_isInterlaced = $this->_binaryReader->readUInt8() !== 0;
        if ($this->_isInterlaced) {
        ...
        do {
            ...
            switch($chunkName) {
                ...
                case 'tRNS':
                     ...
                     */
                    $f = static function($pos) use ($transparency) {
    ...
    public function toXObject(SetaPDF_Core_Document $document)
    {
        ...
        if ('Indexed' === $colorSpace) {
            ...
            $colorSpaceArray = new SetaPDF_Core_Type_Array([
