 ...
 * @version    $Id: Block.php 1597 2020-12-21 15:34:19Z jan.slabon $
 */
...
class SetaPDF_Core_Text_Block
{
     ...
     * @return mixed
     */
    protected function _getManualLineBreaks()
    {
        $this->_getLines();
        return $this->_dataCache['manualLineBreaks'];
    }
    ...
    protected function _drawText(SetaPDF_Core_Canvas $canvas, $x, $y)
    {
        ...
        $manualLineBreaks = $this->_getManualLineBreaks();
        $underlines = [];
            ...
            if (($this->_align !== SetaPDF_Core_Text::ALIGN_LEFT && $line) || $this->_underline) {
                ...
                switch ($this->_align) {
                    ...
                    case SetaPDF_Core_Text::ALIGN_JUSTIFY:
                        if ($lastLineNo === $lineNo || in_array($lineNo, $manualLineBreaks)) {
                            $wordSpacing = 0;
                            break;
                        }
