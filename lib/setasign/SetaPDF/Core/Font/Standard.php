 ...
 * @version    $Id: Standard.php 1560 2020-09-24 12:17:20Z maximilian.kresse $
 */
...
abstract class SetaPDF_Core_Font_Standard extends SetaPDF_Core_Font_Simple
{
    ...
    public function getGlyphWidthByCharCode($charCode)
    {
        ...
        } else if ($this instanceof SetaPDF_Core_Font_Standard_ZapfDingbats) {
