 ...
 * @version    $Id: TrueType.php 1560 2020-09-24 12:17:20Z maximilian.kresse $
 */
    ...
    extends SetaPDF_Core_Font_Type1
{
    ...
    protected function _ensureUnderlinePosition()
    {
         ...
         */
        $table = $parser->getTable(SetaPDF_Core_Font_TrueType_Table_Post::TAG);
        return $table->getUnderlinePosition();
    }
    ...
    protected function _ensureUnderlineThickness()
    {
         ...
         */
        $table = $parser->getTable(SetaPDF_Core_Font_TrueType_Table_Post::TAG);
        return $table->getUnderlineThickness();
    }
}
