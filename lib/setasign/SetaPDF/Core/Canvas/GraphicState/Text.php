 ...
 * @version    $Id: Text.php 1562 2020-09-24 15:47:29Z maximilian.kresse $
 */
...
class SetaPDF_Core_Canvas_GraphicState_Text
{
    ...
    public function toUserSpace(SetaPDF_Core_Geometry_Vector $vector = null)
    {
        ...
        return $vector->multiply(
            $this->getTextMatrix()->multiply($this->_graphicState->getCurrentTransformationMatrix())
        );
    }
