...
var COMPONENTNAME = 'atto_charmap',
    ...
    CHARMAP = [
        ...
        ['&sim;', '&#8764;', true, 'similarto'],
        ['&cong;', '&#8773;', true, 'approximatelyequalto'],
        ['&asymp;', '&#8776;', true, 'almostequalto'],
        ['&ne;', '&#8800;', true, 'notequalto'],
        ['&equiv;', '&#8801;', true, 'identicalto'],
        ['&isin;', '&#8712;', true, 'elementof'],
        ['&notin;', '&#8713;', true, 'notanelementof'],
        ['&ni;', '&#8715;', true, 'containsasmember'],
        ...
        ['&forall;', '&#8704;', true, 'forall'],
        ['&exist;', '&#8707;', true, 'thereexists'],
        ['&empty;', '&#8709;', true, 'diameter'],
        ['&nabla;', '&#8711;', true, 'backwarddifference'],
        ['&lowast;', '&#8727;', true, 'asteriskoperator'],
        ['&prop;', '&#8733;', true, 'proportionalto'],
        ['&ang;', '&#8736;', true, 'angle'],
        // Undefined.
        ['&acute;', '&#180;', true, 'acuteaccent'],
        ['&cedilla;', '&#184;', false, 'cedilla'], //ecastro ULPGC
        ...
        ['&psi;', '&#968;', true, 'psi'],
        ['&omega;', '&#969;', true, 'omega'],
        // Symbols. // ecastro ULPGC
        ['&alefsym;', '&#8501;', true,'alefsymbol'],
        ['&piv;',     '&#982;',  true,'pisymbol'],
        ['&real;',    '&#8476;', true,'realpartsymbol'],
        ['&thetasym;','&#977;',  false,'thetasymbol'],
        ['&upsih;',   '&#978;',  false,'upsilonhooksymbol'],
        ['&weierp;',  '&#8472;', true,'weierstrassp'],
        ['&image;',   '&#8465;', true,'imaginarypart'],
        // Arrows.
        ...
        ['&crarr;',   '&#8629;', true,'carriagereturn'],
        ['&lArr;',    '&#8656;', true,'leftwardsdoublearrow'],
        ['&uArr;',    '&#8657;', true,'upwardsdoublearrow'],
        ['&rArr;',    '&#8658;', true,'rightwardsdoublearrow'],
        ['&dArr;',    '&#8659;', true,'downwardsdoublearrow'],
        ['&hArr;',    '&#8660;', true,'leftrightdoublearrow'],
        ['&there4;',  '&#8756;', true,'therefore'],
        ['&sub;',     '&#8834;', true,'subsetof'],
        ['&sup;',     '&#8835;', true,'supersetof'],
        ['&nsub;',    '&#8836;', true,'notasubsetof'],
        ['&sube;',    '&#8838;', true,'subsetoforequalto'],
        ['&supe;',    '&#8839;', true,'supersetoforequalto'],
        ['&oplus;',   '&#8853;', true,'circledplus'],
        ['&otimes;',  '&#8855;', true,'circledtimes'],
        ...
        ['&lang;',    '&#9001;', true,'leftpointinganglebracket'],
        ['&rang;',    '&#9002;', true,'rightpointinganglebracket'],
        ['&loz;',     '&#9674;', true, 'lozenge'],
