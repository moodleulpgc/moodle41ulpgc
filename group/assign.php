...
$strgroupings = get_string('groupings', 'group'); // ecastro ULPGC use groupings in navbar
...
$PAGE->navbar->add($strgroupings, new moodle_url('/group/groupings.php', array('id'=>$courseid))); // ecastro ULPGC use groupings in navbar
...
/// Print header
$PAGE->set_title("$course->shortname: $strgroupings");
