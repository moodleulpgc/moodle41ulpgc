...
/**
 * Multicohort sync enrolments task.
 *
...
namespace enrol_multicohort\task;
...
class sync_enrolments extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('syncenrolmentstask', 'enrol_multicohort');
    }

    /**
     * Run task for syncing multicohort enrolments.
     */
    public function execute() {
        ...
        enrol_multicohort_sync($trace,  null, null);
        $trace->finished();
    }
}
