...
$PAGE->set_url('/enrol/waitlist/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolwaitlistconfirm', 'enrol_waitlist', format_string($course->fullname));
