...
$string['usewaitlist_help'] = 'If enabled, then the wait list will be used. If not, any enrol attempt aftetr max limit reached will be rejected.';
$string['confirmationfullno'] = '<strong>This course is presently fully booked. NO more enrolments are possible.</strong>';
