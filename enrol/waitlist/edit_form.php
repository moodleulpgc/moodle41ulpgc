...
class enrol_waitlist_edit_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('selectyesno', 'customint5', get_string('usewaitlist', 'enrol_waitlist'));
        $mform->addHelpButton('customint5', 'usewaitlist', 'enrol_waitlist');
        $mform->setDefault('customint5', 0);

        $mform->addElement('text', 'customint6', get_string('maxcourses', 'enrol_waitlist'));
        $mform->setDefault('customint6', 0);
        $mform->addHelpButton('customint6', 'maxcourses', 'enrol_waitlist');
