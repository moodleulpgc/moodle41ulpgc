...
$string['metacat:config'] = 'Configurar instancias de metacat';
$string['metacat:selectaslinked'] = 'Selecionar como meta enlazado';
$string['metacat:unenrol'] = 'Desmatricular usuarios';
