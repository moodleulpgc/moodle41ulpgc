...
/**
 * Event observer for metapattern enrolment plugin.
 *
 * @package    enrol_metapatern
...
/**
 * Event observer for enrol_metapattern.
 *
 * @package    enrol_metapattern
 * @copyright  2016 Enrique Castro @ ULPGC
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_metapattern_observer extends enrol_metapattern_handler{
    ...
    public static function user_enrolment_created(\core\event\user_enrolment_created $event) {
        ...
        if ($event->other['enrol'] === 'metapattern') {
    ...
    public static function role_assigned(\core\event\role_assigned $event) {
        ...
        if ($event->other['component'] === 'enrol_metapattern') {
            return true;
        }
    ...
    public static function course_deleted(\core\event\course_deleted $event) {
        ...
        if (!$enrols = $DB->get_records('enrol', array('customint1' => $event->objectid, 'enrol' => 'metapattern'),
                'courseid ASC, id ASC')) {
            return true;
        }
        ...
        foreach ($enrols as $enrol) {
            ...
            if ($unenrolaction == ENROL_EXT_REMOVED_SUSPENDNOROLES) {
                ...
                role_unassign_all(array('contextid'=>$context->id, 'component'=>'enrol_metapattern', 'itemid'=>$enrol->id));
            }
        }
