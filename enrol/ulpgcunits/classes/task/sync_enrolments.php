...
namespace enrol_ulpgcunits\task;
...
class sync_enrolments extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('syncenrolmentstask', 'enrol_ulpgcunits');
    }

    /**
     * Run task for syncing ulpgcunits enrolments.
     */
    public function execute() {
        ...
        enrol_ulpgcunits_sync($trace,  null, null);
        $trace->finished();
    }
}
