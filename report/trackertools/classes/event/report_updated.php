...
/**
 * The report_trackertools report updated event.
 *
...
class report_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportupdated', 'report_trackertools');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' executed the trackertools report '{$this->other['action']}' 
                for the module with id '{$this->contextinstanceid}'. {$this->other['count']} issues updated content. ";
    }
