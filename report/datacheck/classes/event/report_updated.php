...
/**
 * The report_datacheck report updated event.
 *
...
/**
 * The report_datacheck report updated event class.
 *
 * @package    report_datacheck
 * @since      Moodle 2.7
 * @copyright  2017 Enrique Castro @ULPGC
...
class report_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportupdated', 'report_datacheck');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' updated field values with the datacheck report 
