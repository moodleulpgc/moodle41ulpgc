 ...
 */
class team_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventteamcreated', 'report_o365channels');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has created Team object with id '{$this->objectid}', 
