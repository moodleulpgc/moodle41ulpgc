...
$string['dashboard_title'] = 'Device analytics dashboard';
...
// ecastro ULPGC
$string['deviceanalytics:managesettings'] = 'Manage settings';
$string['deviceanalytics:viewdashboard'] = 'View analytics dashboard';
