...
*/
// ecastro ULPGC
list($url, $contexts, $cmid, $cm, $module, $pagevars) =
        question_edit_setup('questions', '/local/questionbulkupdate/bulkupdate.php');
        
$pageparams = $url->params();        
...
$PAGE->set_heading($course->fullname); // ecastro ULPGC

$mform = new \local_questionbulkupdate\form($url, array('context' => $context, 
                                            'defaultcategory'=>$pagevars['cat'])); // ecastro ULPGC
...
echo $OUTPUT->heading(get_string('pluginname', 'local_questionbulkupdate'));
$mform->display();
echo $OUTPUT->footer();
