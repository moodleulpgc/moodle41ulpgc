...
class teamschannelsync extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('task_teamnamesync', 'local_o365teams');
    }
    ...
    public function execute() {
        ...
        $advancedteamnames = get_config('local_o365teams', 'advancedteamnames');
        if(!$advancedteamnames) {
            // Configured nothing to do, exit
            return true;            
        }
        ...
        $courseteamsync->process_courses_team_name_update();
