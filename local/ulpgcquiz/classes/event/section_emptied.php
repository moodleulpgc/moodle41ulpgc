...
namespace local_ulpgcquiz\event;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class section_emptied extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsectionemptied', 'local_ulpgcquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has emptied the section '{$this->other['sectionid']}' for the quiz with " .
