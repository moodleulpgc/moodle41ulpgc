...
$string['modcannotbemoved'] = 'Cannot move item: "{$a}" (no permissions)';
$string['modcannotbedeleted'] = 'Cannot delete item: "{$a}" (no permissions)';
$string['modcannotbeduped'] = 'Cannot duplicate item: "{$a}" (no permissions)';
$string['sectioncannotreceive'] = 'Section "{$a}" cannot accept that movement (no permissions)';
$string['sectioncannotmove'] = 'Section "{$a}" cannot be moved (no permissions)';
$string['illegalsectionmove'] = 'Section movement not allowed: <br />{$a} ';
$string['illegalmodmove'] = 'Item movement not allowed: <br />{$a} ';
$string['illegalmoddelete'] = 'Item removal not allowed: <br />{$a} ';
$string['illegalmodduplicate'] = 'Item duplication not allowed: <br />{$a} ';
