...
$string['modcannotbemoved'] = 'No se puede mover el ítem: "{$a}" (no tiene permiso)';
$string['modcannotbedeleted'] = 'No se puede borrar el ítem: "{$a}" (no tiene permiso)';
$string['modcannotbeduped'] = 'No se puede duplicar el ítem: "{$a}" (no tiene permiso)';
$string['sectioncannotreceive'] = 'La sección "{$a}" no puede aceptar este movimiento (no tiene permiso)';
$string['sectioncannotmove'] = 'La sección "{$a}" no puede ser movida (no tiene permiso)';
$string['illegalsectionmove'] = 'Movimiento de sección no permitido: <br />{$a} ';
$string['illegalmodmove'] = 'Movimiento de ítem no permitido: <br />{$a} ';
$string['illegalmoddelete'] = 'Borrado de ítem no permitido: <br />{$a} ';
$string['illegalmodduplicate'] = 'Duplicación de ítem no permitida: <br />{$a} ';
