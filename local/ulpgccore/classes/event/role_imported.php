 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class role_imported extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventroleimported', 'local_ulpgccore');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' imported the role with id '$this->objectid' from preset file '{$this->other['preset']}.xml' .";
    }
