...
/**
 * Local plugin "ULPGC core" - JS code for collapsing nav drawer nodes
 *
 * @package    local_ulpgccore
 * @copyright  2018 Enrioque Castro ULPGC based from
    ...
    function toggleClickHandler(node, nodename) {
        node.click(function(e) {
            ...
            if (node.attr('data-collapse') == 0) {
                ...
                M.util.set_user_preference('local_ulpgccorenav-collapse_' + nodename + 'node', 1);
                ...
                // Save this state to the user preferences.
                M.util.set_user_preference('local_ulpgccorenav-collapse_' + nodename + 'node', 0);
            }
        });
    }
