...
$plugin = 'supervisionwarning_unreplied_forum';
...
$settings->add(new admin_setting_configtext("$plugin/threshold", get_string('threshold', $plugin), get_string('config_threshold', $plugin), 2, PARAM_INT));
